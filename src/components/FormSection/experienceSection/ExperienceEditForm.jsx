  ...
  return (
    <>
      ...
      <div className="form-container">
        <FormInput id="company" labelText="Company" handleInputsChange={handleUpdate} defaultValue={currentExperience.company} type="text" />
        <FormInput id="title" labelText="Title" handleInputsChange={handleUpdate} defaultValue={currentExperience.title} type="text" />
